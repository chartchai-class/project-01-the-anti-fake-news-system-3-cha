  ...
  <div class="container mx-auto p-4 max-w-4xl">
    <div class="flex flex-col items-start text-sm font-sans mb-4">
      <div class="flex items-center">
        <svg mlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" class="h-4 w-4 mr-1 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
