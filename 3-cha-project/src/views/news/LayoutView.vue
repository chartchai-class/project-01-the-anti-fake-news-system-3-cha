...
<style scoped>
.nav-tab {
  @apply flex items-center gap-3 px-6 py-3 rounded-xl text-gray-600 font-medium transition-all duration-300 hover:text-gray-900 hover:bg-white hover:shadow-md relative overflow-hidden whitespace-nowrap;
}

.nav-tab-active {
  @apply bg-white text-[#19B917] shadow-lg scale-105 font-semibold;
}

.nav-tab-active::before {
  content: '';
  @apply absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#19B917] to-green-600;
}
...
.nav-tab:focus-visible {
  @apply outline-none ring-2 ring-[#19B917] ring-offset-2;
}
